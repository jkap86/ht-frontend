...
_$DraftImpl _$$DraftImplFromJson(Map<String, dynamic> json) => _$DraftImpl(
      ...
      totalRosters: (json['totalRosters'] as num).toInt(),
      ...
      commissionerRosterId: (json['commissionerRosterId'] as num?)?.toInt(),
      userRosterId: (json['userRosterId'] as num?)?.toInt(),
...
Map<String, dynamic> _$$DraftImplToJson(_$DraftImpl instance) =>
    <String, dynamic>{
      ...
      'totalRosters': instance.totalRosters,
      ...
      'commissionerRosterId': instance.commissionerRosterId,
      'userRosterId': instance.userRosterId,
